...
const Hero: React.FC = () => {
  return (
    <section className="relative min-h-screen flex items-center pt-28 pb-20 md:pt-20 overflow-hidden px-4 md:px-8">
      ...
      <div className="max-w-[96%] 2xl:max-w-[1800px] mx-auto relative z-10 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <div className="text-center lg:text-left order-2 lg:order-1">
            ...
            <h1 className="text-5xl md:text-7xl xl:text-8xl 2xl:text-9xl font-black text-white tracking-tighter leading-[0.85] mb-8 uppercase">
              Hello, I'm <br />
            ...
            <p className="text-lg md:text-2xl text-slate-400 max-w-3xl mx-auto lg:mx-0 mb-12 leading-relaxed font-light">
          ...
          <div className="relative order-1 lg:order-2">
             <div className="relative w-full aspect-square max-w-xl mx-auto lg:ml-auto transform hover:scale-[1.01] transition-transform duration-700">
                ...
                <div className="absolute inset-0 bg-slate-900/50 backdrop-blur-3xl border border-slate-800 rounded-[3rem] shadow-2xl flex items-center justify-center overflow-hidden">
                   ...
                   <div className="p-8 md:p-12 font-mono text-left w-full h-full flex flex-col justify-center">
                ...
                <div className="absolute -bottom-6 -right-6 md:-right-8 bg-slate-900 border border-slate-800 p-6 rounded-3xl shadow-2xl backdrop-blur-xl animate-bounce duration-[3000ms]">
